...
describe('Turn', () => {
  ...
  beforeEach( () => {
    ...
    turn = new Turn('blue and green', card);
  });
  ...
  it('should be able to store a player\'s guess', () => {
    ...
    expect(turn.guess).to.equal('blue and green');
  });
  ...
  it('should be able to return the player\'s guess', () => {
    ...
    expect(returnedGuess).to.equal('blue and green');
  });
  ...
  it('should be able to evaluate the player\'s guess against the correct answer', () => {
    const wrongTurn = new Turn('red and yellow', card);
    const rightTurn = new Turn('blue and green', card);
